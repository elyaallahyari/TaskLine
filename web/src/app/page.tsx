    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 pb-24 pt-16">
        ...
        <p className="mt-5 max-w-xl text-lg leading-7 text-muted-foreground">
          TaskLine is a small workspace for boards, dates, and timelines. Same job as
          the heavy tools — fewer screens, less chrome, your name on the work.
        </p>
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Demo: demo@taskline.app / demo1234
        </p>
        ...
        <section className="mt-20 rounded-2xl border border-border bg-card px-8 py-10">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            The next version is meant to talk to agents from a board, a task, or the
            timeline. This release stays honest: lists, dates, and a line you can follow.
          </p>
        </section>
      </main>
